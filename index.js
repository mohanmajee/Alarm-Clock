...
function createNewAlarmDOM(){
    ...
    alarmItem.classList.add('alarm-items');
        ...
        logo.setAttribute('src', 'https://cdn-icons-png.flaticon.com/512/92/92386.png');
        ...
        delButton.setAttribute('src', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_xpgcd_DICcKHJpE_vE9FVZ1Znf6C5KWhVqd4vnBn&s');
